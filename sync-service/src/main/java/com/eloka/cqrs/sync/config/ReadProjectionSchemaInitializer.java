package com.eloka.cqrs.sync.config;
...
@Component
public class ReadProjectionSchemaInitializer implements ApplicationRunner {

    private final JdbcTemplate jdbcTemplate;

    public ReadProjectionSchemaInitializer(JdbcTemplate jdbcTemplate) {
